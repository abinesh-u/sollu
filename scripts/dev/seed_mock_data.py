...
tasks = [
    ...
    {
        "task": "Send a loom video to Ravi before the standup",
        "lane": "now",
        "class": "message_person",
        "status": "pending_approval",
    },
    {
        "task": "Look into whether the cloud SQL migration is worth it",
        "lane": "next",
        "class": "research",
        "status": "pending_approval",
    },
    {
        "task": "Check if flight to Bangalore drops below 15,000 rupees",
        "lane": "next",
        "class": "watch_price",
        "status": "auto_approved",
    },
    {
        "task": "Redo the onboarding flow",
        "lane": "later",
        "class": "other",
        "status": "pending_approval",
    },
